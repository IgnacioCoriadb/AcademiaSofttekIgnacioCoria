		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsofftekaca20241q-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsofftekaca20241q-display": {
								"semanticObject": "comsofftekaca20241q",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sofftek.aca20241q",
									"url": sap.ui.require.toUrl("com/sofftek/aca20241q")
								}
							}
						}
					}
